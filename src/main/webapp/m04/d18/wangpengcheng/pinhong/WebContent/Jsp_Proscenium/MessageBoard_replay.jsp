...
<body background="Img_Background/1/bookbg.gif">
	...
	<c:forEach items="${listMessageMid }" var="message">
	  <tr>
	  ...
	  <tr>
	    <td height="18" colspan="4"><table width="750" border="0" cellspacing="0" cellpadding="0">
	      ...
	      <c:if test="${not empty listRevertMid}">
	      <c:forEach items="${listRevertMid}" var="re">
	      <tr>
	  ...
	  <tr>
	    <td height="25" colspan="4"><form id="form1" name="form1" method="post" action="<%=basePath %>servlet/InsertRevertServlet" target="_parent">
	          ...
	          <table width="750" border="0" cellpadding="0" cellspacing="0">
	            ...
	            <tr>
	              ...
	              <td width="642" class="right"><label>
	                <input type="text" name="name" size="15" value="${sessionScope.username }"/><input name="messageid" type="hidden" value="${listMessageMid[0].mid }" size="5" />
	                </label></td>
	            </tr>
	            <tr>
	              <td class="l">&nbsp;</td>
