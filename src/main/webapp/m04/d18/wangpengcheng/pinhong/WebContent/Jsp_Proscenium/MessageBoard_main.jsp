	        ...
	        <table width="750" border="0" cellspacing="0" cellpadding="0" style="font-size:12px;">
			  ...
			  <c:if test="${not empty listMessage}">
			  	<c:forEach items="${listMessage}" var="m">
		            ...
		            <td height="25" class="lb"><span class="gray">&nbsp;<img src="Img_Background/1/jd-to.gif" width="13" height="13" border="0" />&nbsp;<a href="<%=basePath %>servlet/InsertMessageServlet?mid=${m.mid }" target="_parent" >${m.mtitle }</a></span></td>
		           </c:if>
		           <c:if test="${ empty sessionScope.username }">
		            <td height="25" class="lb"><span class="gray">&nbsp;<img src="Img_Background/1/jd-to.gif" width="13" height="13" border="0" />&nbsp;<a href="<%=basePath %>servlet/JumpServlet?replay=replay" target="_parent">${m.mtitle }</a></span></td>
		           </c:if>
