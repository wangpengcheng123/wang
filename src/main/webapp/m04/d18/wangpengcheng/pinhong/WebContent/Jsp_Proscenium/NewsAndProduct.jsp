...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=basePath %>js/jquery-1.8.3.js"></script>
 	...
 	$(function(){
 		$("table tr[class='tr_td']:odd").css("background-color","green");
 	});
 	</script>
  </head>
	...
	<table align="center" width="620" height="230" border="0" cellpadding="0" cellspacing="0">
	  <tr height="35">
		...
		<c:if test="${not empty listNews}">
			<c:forEach items="${sessionScope.listNews}" var="news" varStatus="i">
				
				<tr class="tr_td">
					<td height="22">&nbsp;<a target="_parent" href="News?id=${news.nid }">${news.ntitle }&nbsp;&nbsp;&nbsp;<span style="color: red;">[${news.ndate}]</span></a></td>
				</tr>
			  	<tr>
