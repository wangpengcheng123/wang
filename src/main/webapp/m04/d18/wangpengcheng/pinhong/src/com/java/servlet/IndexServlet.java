...
public class IndexServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        /*
         * // 分页 PageDemo pageDemo = new PageDemo(); // 当前页面 int num = 1;
         * pageDemo.setCurrPage(num); // 数据总数 int count =
         * indexService.selectCount(); pageDemo.setCountNumber(count); // 总页数 if
         * (count % pageDemo.getPageNumber() == 0) { pageDemo.setCountPage(count
         * / pageDemo.getPageNumber()); } else { pageDemo.setCountPage((count /
         * pageDemo.getPageNumber()) + 1); } // 起始数据
         * pageDemo.setStartNumber((num - 1) * pageDemo.getPageNumber());
         * List<Product> listPageProduct =
         * indexService.selectPageInfo(pageDemo);
         */
        ...
        session.setAttribute("listPageProduct", listProduct);
