...
<body background="Img_Background/1/bookbg.gif">
	...
	<table width="750" border="0" cellspacing="0" cellpadding="0" align="center">
	    ...
	    <td colspan="4"><table width="750" height="148" border="0" cellpadding="0" cellspacing="0">
	      <tr>
	        <td><table width="750" height="54" border="0" cellpadding="0" cellspacing="0">
	          <tr>
	            <td height="22" background="Img_Background/1/title.gif" class="ltr"><font style="font-size: 12px; font-weight: bold;">&nbsp;&nbsp;※&nbsp;&nbsp;${message.mtitle}</font></td>
	          </tr>
	          <tr>
	          ...
	          <tr>
	            <td height="20" class="lrb"><span class="gray">&nbsp;${message.mname }&nbsp;写于&nbsp;${message.mdate }</span></td>
	          </tr>
	        </table></td>
	      </tr>
	    </table></td>
	  ...
	  <c:forEach items="${listRevert }" var="lrevert">
	      <tr>
	                ...
	                <tr>
	                  <td><table width="750" border="0" cellspacing="0" cellpadding="0">
	                    ...
	                    <tr>
	                      <td><table width="750" height="54" border="0" cellpadding="0" cellspacing="0">
	                        <tr>
	                          <td height="22" class="ltr"><p class="content">&nbsp;${lrevert.rcontent }</p></td>
	                        </tr>
	                        <tr>
	                          <td height="100" class="lrb" ><p class="content">&nbsp;</p></td>
	                        </tr>
	                        <tr>
	                          <td height="20" class="lrb"><span class="gray">&nbsp;${lrevert.rname}&nbsp;写于&nbsp;${lrevert.rdate }</span></td>
	                        </tr>
	                      </table></td>
	                    </tr>
	                    <tr>
	  ...
	  <tr>
	    <td height="25" colspan="4"><form id="form1" name="form1" method="get" action="<%=path %>/addrevert" target="_parent">
	          ...
	          <table width="750" border="0" cellpadding="0" cellspacing="0">
	            ...
	            <tr>
	              ...
	              <c:when test="${not empty user }">
	                <input type="text" name="name" size="15" value="${user }" id="name" readonly/><input name="messageid" type="hidden" value="${message.mid}" size="5" />	              
	              </c:when>
	              <c:otherwise>
	                <input type="text" name="name" size="15" value="" id="name" readonly/><input name="messageid" type="hidden" value="${message.mid}" size="5" />	              
	              </c:otherwise>
	              </c:choose>
	                </label></td>
	            </tr>
	            ...
	            <tr>
	              ...
	              <td class="rb">
	                <label>
	                    <input type="image" src="Img_Background/1/post.gif" id="img" >
	                </label>
	                <label>
	                    <a href='<%=path %>/msglogin'>登录</a>
	                </label>
	              </td>            
	            </tr>
	            <tr>
