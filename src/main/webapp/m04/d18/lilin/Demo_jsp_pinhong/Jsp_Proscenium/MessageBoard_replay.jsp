...
<body background="Img_Background/1/bookbg.gif">
	<table width="750" border="0" cellspacing="0" cellpadding="0" align="center">
	  <tr>
	    <td height="25" colspan="4"><span class="title">主题: ${mg.mtitle }</span></td>
	  </tr>
	  <tr>
	    ...
	    <td colspan="4"><table width="750" height="148" border="0" cellpadding="0" cellspacing="0">
	      <tr>
	        <td><table width="750" height="54" border="0" cellpadding="0" cellspacing="0">
	          <tr>
	            <td height="22" background="Img_Background/1/title.gif" class="ltr"><font style="font-size: 12px; font-weight: bold;">&nbsp;&nbsp;※&nbsp;&nbsp;${mg.mtitle }</font></td>
	          </tr>
	          <tr>
	            <td height="20" class="lr" ><p class="content">&nbsp;${mg.mcontent }</p></td>
	          </tr>
	          <tr>
	            <td height="100" class="lrb">&nbsp;</td>
	          </tr>
	          <tr>
	            <td height="20" class="lrb"><span class="gray">&nbsp;${mg.mname }&nbsp;写于&nbsp;${mg.mdate }</span></td>
	          </tr>
	        </table></td>
	      </tr>
	    </table></td>
	  ...
	  <tr>
	    <td height="25" colspan="4"><form id="form1" name="form1" method="get" action="<%=path %>/ServletAdd" target="_parent">
	          ...
	          <table width="750" border="0" cellpadding="0" cellspacing="0">
	            ...
	            <tr>
	              ...
	              <td width="642" class="right"><label>
	                <input type="text" name="name" size="15"/><input name="messageid" type="hidden" value="${mg.mid }" size="5" />
	                </label></td>
	            </tr>
	            <tr>
	              <td class="l">&nbsp;</td>
