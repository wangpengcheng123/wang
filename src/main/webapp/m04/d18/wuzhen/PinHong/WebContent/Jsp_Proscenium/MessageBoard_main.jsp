	        ...
	        <table width="750" border="0" cellspacing="0" cellpadding="0" style="font-size:12px;">
			  ...
			  <c:if test="${not empty msglist}">
			  	<c:forEach items="${msglist}" var="m">
		            ...
		            <td height="25" class="lb"><span class="gray">&nbsp;<img src="Img_Background/1/jd-to.gif" width="13" height="13" border="0" />&nbsp;<a href="<%=path %>/getvaluebyid?id=${m.mid }" target="_parent">${m.mtitle }</a></span></td>
