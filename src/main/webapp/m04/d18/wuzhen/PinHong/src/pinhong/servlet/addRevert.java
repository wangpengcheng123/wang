...
public class addRevert extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(flag>0){  
            List<Revert> listRevert= bdi.getRevert(Integer.valueOf(replyid));
            session.setAttribute("listRevert", listRevert);
            int count=bdi.getRevertInfo(Integer.valueOf(replyid));          
            bdi.modifyMessage(count,Integer.valueOf(replyid));       
