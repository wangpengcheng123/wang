    ...
    <div class="content">
      ...
      <ul class="classlist">
    	...
    	bsi.setBizDao(bdi);//注入
   		List<CommentInfo> listnews1= bsi.getComment();
   		for(int i=0;i<listnews1.size();i++){
   		
   			out.print("<li><a href='newspages/news_add.html'>"+listnews1.get(i).getContent()+"</a><span>"+ listnews1.get(i).getFbtime() +"</span></li>");
   	}
   	 %>
      
        <li><a href='newspages/news_add.html'> 深足教练组：说我们买球是侮辱 朱广沪常暗中支招 </a><span> 2009-10-28 01:03:51.0 </span></li>
      <!--   <li><a href='#'>
       省政府500万悬赏建业登顶 球员:遗憾主场放跑国安 </a><span> 2009-10-28 01:03:19.0 </span></li>
