  ...
  <div id="opt_area">
    ...
    <c:forEach items="${listNews }" var="news">
      <li>${news.news_title } <span> 作者：
        ${news.news_author }                                           
        &#160;&#160;&#160;&#160; <a href="<%=basePath %>/pages/admin/news_modify.jsp?title=${news.news_title }&author=${news.news_author}&summary=${news.news_summary}&content=${news.news_content}&newsId=${news.news_id}">修改</a>
