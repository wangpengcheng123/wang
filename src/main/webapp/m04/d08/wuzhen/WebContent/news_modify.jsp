...
<div id="admin_bar">
  <div id="status">管理员：<span class="sp"><%=session.getAttribute("name1") %></span> 登录  &#160;&#160;&#160;&#160; <a href="index.html">login out</a></div>
  <div id="channel"> </div>
</div>
<div id="main">
   <div id="opt_list">
  ...
  <div id="opt_area">
    ...
    <form action="submit.jsp" method="post"  onsubmit="return check()">
      <p>
        <label> 主题 </label><input type="hidden" name="id" value=<%=id %>>
        <select name="ntid">
      ...
      <input type="submit" value="提交" class="opt_sub" onclick="submit()"/>
