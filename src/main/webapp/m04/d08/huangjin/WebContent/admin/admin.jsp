   	...
   	<%
    	...
    	bsi.setBizDao(bdi);//注入
   		...
   		for(int i=0;i<listnews.size();i++){
   			out.print("<li>"+listnews.get(i).getNewstitle()+"<span>作者:"+listnews.get(i).getNewsauthor()+"&#160;&#160;&#160;&#160; <a href='news_modify.html'>修改</a> &#160;&#160;&#160;&#160; <a href='#' onclick='return clickdel()'>删除</a> </span></li>");
   	}
   	 %>
