	                ...
	                <tr>
	                  <td><table width="750" border="0" cellspacing="0" cellpadding="0">
	                    ...
	                    <tr>
	                      <td><table width="750" height="54" border="0" cellpadding="0" cellspacing="0">
	                        <tr>
	                          <td height="22" class="ltr"><p class="content">&nbsp;${r.rcontent }</p></td>
	                        </tr>
	                        <tr>
	                          <td height="100" class="lrb" ><p class="content">&nbsp;</p></td>
	                        </tr>
	                        <tr>
	                          <td height="20" class="lrb"><span class="gray">&nbsp;${r.rname}&nbsp;写于&nbsp;${r.rdate }</span></td>
	                        </tr>
	                      </table></td>
	                    </tr>
	                    <tr>
	          ...
	          <table width="750" border="0" cellpadding="0" cellspacing="0">
	            ...
	            <tr>
	              ...
	              <td width="642" class="right"><label>
	                <input type="text" name="name" size="15"/><input name="messageid" type="hidden" value="${message.mid}" size="5" />
	                </label></td>
	            </tr>
	            <tr>
	              <td class="l">&nbsp;</td>
