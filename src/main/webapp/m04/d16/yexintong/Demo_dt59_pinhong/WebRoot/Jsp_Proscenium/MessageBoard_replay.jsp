...
<body background="Img_Background/1/bookbg.gif">
	...
	<c:if test="${not empty list}">
	  ...
	  <tr>
	    <td height="25" colspan="4"><span class="title">主题: ${m.mtitle }</span></td>
	  </tr>
	  <tr>
	    ...
	    <td colspan="4"><table width="750" height="148" border="0" cellpadding="0" cellspacing="0">
	      <tr>
	        <td><table width="750" height="54" border="0" cellpadding="0" cellspacing="0">
	          <tr>
	            <td height="22" background="Img_Background/1/title.gif" class="ltr"><font style="font-size: 12px; font-weight: bold;">&nbsp;&nbsp;※&nbsp;&nbsp;${m.mtitle }</font></td>
	          </tr>
	          <tr>
	            <td height="20" class="lr" ><p class="content">&nbsp;${m.mcontent }</p></td>
	          </tr>
	          <tr>
	            <td height="100" class="lrb">&nbsp;</td>
	          </tr>
	          <tr>
	            <td height="20" class="lrb"><span class="gray">&nbsp;${m.mname }&nbsp;写于&nbsp;${m.mdate }</span></td>
	          </tr>
	        </table></td>
	      </tr>
	       	</c:forEach>
	  ...
	  <tr>
	    <td height="18" colspan="4"><table width="750" border="0" cellspacing="0" cellpadding="0">
	      ...
	      <c:forEach items="${listReplies}" var="re">
	      <tr>
	  ...
	  <tr>
	    <td height="25" colspan="4"><form id="form1" name="form1" method="post" action="	InServly" target="_parent">
