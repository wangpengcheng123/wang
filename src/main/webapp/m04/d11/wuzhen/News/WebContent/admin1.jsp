...
<%  
   ...
   BizDaoImp bdi=new BizDaoImp(); 
     List<NewsInfo> list=(List<NewsInfo>)request.getAttribute("list");    
...
<% Page cpage=(Page)request.getAttribute("page1");%>
      <li class='space'>     
      <a href="page.jsp?currentPage=1">首页&nbsp;</a> 
      <a href="page.jsp?currentPage=<%=cpage.getCurrentPage()-1 %>">上一页</a>
      <a href="page.jsp?currentPage=<%=cpage.getCurrentPage()+1 %>">下一页</a> 
      <a href="page.jsp?currentPage=<%=cpage.getTotalPage() %>">末页</a>
      </li>
   </ul>
  </div>
</div>
