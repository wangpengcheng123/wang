...
<div id="admin_bar">
  <div id="status">管理员：<span id="sp"></span> 登录  &#160;&#160;&#160;&#160; <a href="index.html">login out</a></div>
  <div id="channel"> </div>
</div>
<div id="main">
  <div id="opt_list">
...
<script language="javascript">
    ...
    <ul class="classlist">
   	<%
    	...
    	bsi.setBizDao(bdi);//注入
   		...
   		for(int i=0;i<listnews.size();i++){
   			...
   			listnews.get(i).getNewsauthor()+"&#160;&#160;&#160;&#160; <a href='xiugai.jsp?uname="+listnews.get(i).getNewsauthor()+"&title="+listnews.get(i).getNewstitle()+"&sid="+listnews.get(i).getNewsid()+"'>修改</a> &#160;&#160;&#160;&#160; "+
     ...
     <!--  <li> 深足教练组：说我们买球是侮辱 朱广沪常暗中支招 <span> 作者：
      ...
      <a href="spage.jsp?currentpage=<%=pg.getCurrentpae()-1%>">上一页</a>     
      <a href="spage.jsp?currentpage=<%=pg.getCurrentpae()+1%>">下一页</a> 
      <a href="spage.jsp?currentpage=<%=pg.getSumsize()/pg.getPagesize()+1%>">末页</a> 
      </p>
    </ul>
  </div>
</div>
