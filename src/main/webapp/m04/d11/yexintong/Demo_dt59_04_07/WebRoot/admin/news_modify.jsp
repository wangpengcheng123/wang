...
<div id="main">
  ...
  <div id="opt_area">
    ...
    <!--<form action="tijao.jsp" method="get" enctype="multipart/form-data" onsubmit="return check()">-->
     <form action="tijiaoresult.jsp" method="post" enctype="multipart/form-data" onsubmit="return check()">
      <p>
        <label> 主题 </label>
        <select name="ntid">
      ...
      <p>
        <label> 作者 </label>
        <input name="nauthor" type="text" class="opt_input" value="<%=session.getAttribute("uname") %>" />
      </p>
      <p>
        <label> 摘要 </label>
      ...
      <p>
        <label> 上传图片 </label>
        <input name="file" type="file" class="opt_input"  name="upload"/>
      </p>
