<%@page import="pinhong.entity.News"%>
  ...
  <body>
	<table align="center" width="620" height="230" border="0" cellpadding="0" cellspacing="0">
	  ...
	  for(int i=0;i<list.size();i++){
	      out.print("<tr><td width='10'>&nbsp;</td><td width='70'>&nbsp;</td><td colspan='3'><a href='#' target='_parent'>"+list.get(i).getNtitle()+"&nbsp;&nbsp;&nbsp;["+list.get(i).getNdate()+"]</a></td></tr>");
	  }
